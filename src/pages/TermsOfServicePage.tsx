...
3. SUB-REGISTRATION, BILLING & REFUND POLICY
...
4. PLATFORM STABILITY & SECURITY COMPLIANCE
We employ state-of-the-art security mechanisms to shield user credentials:
- PKCE Authorization Code Flows: Restricting token handshakes to verified local clients.
- Anti-CSRF Parameters: Forcing cryptographically random state matching on authentication redirects.
- Secure SSL/TLS Restricted Headers: Restricting session exchange strictly to encrypted transport layers.
- RISC Security Synchronization: Instantly invalidating local sessions upon Google Security Event Coordination notices.

Attempting to bypass these configurations, using unauthorized Webview browsers, or spoofing credentials constitutes a material breach and will result in immediate termination of access without refund.

5. KITCHEN LIABILITY & ALLERGEN DISCLAIMER
Our culinary recommendations are generated by language intelligence and scanners. It is your ultimate, absolute responsibility to check raw ingredients and ensure safe handling. We accept zero civil or medical liability for allergies, dietary disputes, foodborne issues, or preparations.

6. ARBITRATION & LEGAL MEDIATION
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="relative p-8 sm:p-10 rounded-3xl bg-graphite border border-white/5 shadow-2xl overflow-hidden leading-relaxed">
          ...
          <div className="space-y-6">
            ...
            <div className="whitespace-pre-wrap font-sans text-xs sm:text-sm text-gray-300 hover:text-white leading-relaxed space-y-4 font-light">
              {termsText}
            </div>
